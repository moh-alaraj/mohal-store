                    ...
                    <div class="col-lg-10 col-md-12 col-lg-offset-1">
                        <div class="ps-product__thumbnail">
                            ...
                            <div class="ps-product__image">
                                <div class="item">
                                    <img height="500" src="{{$products->image_link}}" alt="">
                                </div>
                                @foreach($products->images as $image)
                                <div class="item">
                                    <img width="500"  src="{{$image->image_link}}" alt="">
                                </div>
                                @endforeach
                            </div>
                        </div>
...
{{--                                <img src="{{asset('website/images/shoe-detail/1.jpg')}}" alt="">--}}
{{--                                <img src="{{asset('website/images/shoe-detail/2.jpg')}}" alt="">--}}
{{--                                <img src="{{asset('website/images/shoe-detail/3.jpg')}}" alt="">--}}
{{--                            </div>--}}
                        </div>
                        <div class="ps-product__info">
                            ...
                            <h1>{{$products->name}}</h1>
                            <p class="ps-product__category"><a href="#"> {{$products->category->name}}</a>,<a href="#">
                                {{$products->store->name}}</a></p>
                            <h3 class="ps-product__price">${{$products->sale_price}} <del>${{$products->price}}</del></h3>
                            ...
                            <form action="{{route('cart')}}" method="post" id="addToCart" >
                                @csrf
                            ...
                            <div class="ps-product__shopping"><a class="ps-btn mb-10" href="javascript:;" onclick="document.getElementById('addToCart').submit()">Add to cart<i class="ps-icon-next"></i></a>
                        ...
                        <div class="tab-content mb-60">
                            ...
                            <div class="tab-pane" role="tabpanel" id="tab_02">
                                ...
                                <div class="ps-review">
                                    <div class="ps-review__thumbnail"><img src="{{asset('website/images/user/1.jpg')}}" alt=""></div>
                                ...
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal">
                                            <img src="{{asset('website/images/shoe/2.jpg')}}" alt="">
                        ...
                        <div class="ps-shoes--carousel">
                            <div class="ps-shoe">
                                <div class="ps-shoe__thumbnail">
                                    ...
                                    </a><img src="{{asset('website/images/shoe/2.jpg')}}" alt="">
