...
{{--            </li>--}}
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="{{asset('images/sw.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">Mohal Store</span>
        </a>
            ...
            <nav class="mt-2">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <div class="image">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link">
                                        ...
                                        <i class="fas fa-angle-down spa"></i>
                                </a>
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        @auth
                                            <div class="ms-auto">
                                                <button class="btn btn-sm btn-outline-light" href="#" onclick="document.getElementById('logout').submit()">Logout</button>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('admin.advertise.index')}}" class="nav-link">
                                    <p> Show Advertises </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('admin.advertise.create')}}" class="nav-link">
                                    <p>Create advertise</p>
                                </a>
                            </li>
                        </ul>
                    </li>
